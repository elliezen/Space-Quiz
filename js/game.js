...
class Game {
    ...
    constructor(assets) {
        ...
        this.modalScoreDiv = document.querySelector('.warn__score').firstElementChild;
        this.lives = 4;
    ...
    getProgress(progress) {
        if (!progress) {
            ...
            this.modalScoreDiv.innerHTML = this.score;
        }
    }
    ...
    gameOver() {
        ...
        document.querySelector('.game-overlay').classList.add('overlay--active');
    }
    ...
    render() {
        ...
        this.ctx.drawImage(this.cookie, this.cursor.x - 10, this.cursor.y - 10, 20, 20);
    }
